    ...
    <div class="header">
        <nav>
            ...
            <ul v-if="!mobile" class="navigation">
                <li ><a class="link" href="#"><span>Strona główna</span></a></li>
                <li ><a class="link" href="#"><span>Galeria</span></a></li>
                <li ><a class="link" href="#"><span>Kontakt</span></a></li>
                <li ><a class="link" href="#"><span>Cennik</span></a></li>
            </ul>
